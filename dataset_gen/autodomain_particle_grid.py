...
def parse_args():
    ...
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=Path("/media/dysco/New Volume/Neeraj/neuralop/data/train/pair_4_gno"),
        help="Folder containing frame_*.npz 3D particle files.",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("/media/dysco/New Volume/Neeraj/neuralop/data/train/pair_4_fno_16"),
        help="Output folder for frame_*_grid.npz files.",
    )
    parser.add_argument("--nx", type=int, default=16, help="Grid resolution in x.")
    parser.add_argument("--ny", type=int, default=16, help="Grid resolution in y.")
    parser.add_argument("--nz", type=int, default=16, help="Grid resolution in z.")
    parser.add_argument(
        "--margin-frac",
        type=float,
        default=0.05,
